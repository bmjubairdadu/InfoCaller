...
class InfoCallerApplication : Application() {
    ...
    override fun onCreate() {
        ...
        providerManager.registerProviders(listOf(
            ...
            NumverifyProviderImpl(this, keyManager),
            NumlookupApiProviderImpl(this),
            ...
            BusinessProviderImpl(),
            CoreClawProviderImpl(this),
            ...
            // Room-backed NID (115k indexed) replaces LocalJsonDatabaseProvider (now demoted)
            NidDatabaseProvider(database),
            NidGovEnrichmentProvider(database, commonHttpClient),
            LocalJsonDatabaseProvider(this),
            NidIdentityLookupProviderImpl(),
            // New OSINT providers (free, no keys)
            ...
            HaveIBeenPwnedProviderImpl(commonHttpClient),
